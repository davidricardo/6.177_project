...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'dChar_class.features'
        db.delete_column(u'chargen_dchar_class', 'features')


    def backwards(self, orm):
        # Adding field 'dChar_class.features'
        db.add_column(u'chargen_dchar_class', 'features',
