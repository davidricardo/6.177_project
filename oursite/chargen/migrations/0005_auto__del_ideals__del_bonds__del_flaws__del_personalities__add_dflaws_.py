...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ideals'
        db.delete_table(u'chargen_ideals')

        # Deleting model 'bonds'
        db.delete_table(u'chargen_bonds')

        # Deleting model 'flaws'
        db.delete_table(u'chargen_flaws')

        # Deleting model 'personalities'
        db.delete_table(u'chargen_personalities')

        # Adding model 'dflaws'
        db.create_table(u'chargen_dflaws', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('background', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('one', self.gf('django.db.models.fields.CharField')(max_length=600)),
            ('two', self.gf('django.db.models.fields.CharField')(max_length=600)),
            ('three', self.gf('django.db.models.fields.CharField')(max_length=600)),
            ('four', self.gf('django.db.models.fields.CharField')(max_length=600)),
            ('five', self.gf('django.db.models.fields.CharField')(max_length=600)),
            ('six', self.gf('django.db.models.fields.CharField')(max_length=600)),
        ))
        ...
        db.create_table(u'chargen_dpersonalities', (
            ...
            ('five', self.gf('django.db.models.fields.CharField')(max_length=600)),
            ('six', self.gf('django.db.models.fields.CharField')(max_length=600)),
            ('seven', self.gf('django.db.models.fields.CharField')(max_length=600)),
            ('eight', self.gf('django.db.models.fields.CharField')(max_length=600)),
        ))
    ...
    def backwards(self, orm):
        # Adding model 'ideals'
        db.create_table(u'chargen_ideals', (
            ('four', self.gf('django.db.models.fields.IntegerField')(default=8)),
            ('five', self.gf('django.db.models.fields.IntegerField')(default=8)),
            ('three', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['chargen.dRace'])),
            ('background', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('six', self.gf('django.db.models.fields.IntegerField')(default=8)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('two', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['chargen.dsubclass'])),
            ('one', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['chargen.dChar_class'])),
        ))
        db.send_create_signal('chargen', ['ideals'])

        # Adding model 'bonds'
        db.create_table(u'chargen_bonds', (
            ('four', self.gf('django.db.models.fields.IntegerField')(default=8)),
            ('five', self.gf('django.db.models.fields.IntegerField')(default=8)),
            ('three', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['chargen.dRace'])),
            ('background', self.gf('django.db.models.fields.CharField')(max_length=40)),
        ...
        db.send_create_signal('chargen', ['bonds'])

        # Adding model 'flaws'
        db.create_table(u'chargen_flaws', (
            ('four', self.gf('django.db.models.fields.IntegerField')(default=8)),
            ('five', self.gf('django.db.models.fields.IntegerField')(default=8)),
            ('three', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['chargen.dRace'])),
            ('background', self.gf('django.db.models.fields.CharField')(max_length=40)),
        ...
        db.send_create_signal('chargen', ['flaws'])

        # Adding model 'personalities'
        db.create_table(u'chargen_personalities', (
            ('seven', self.gf('django.db.models.fields.IntegerField')(default=8)),
            ('two', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['chargen.dsubclass'])),
            ('four', self.gf('django.db.models.fields.IntegerField')(default=8)),
            ('eight', self.gf('django.db.models.fields.IntegerField')(default=8)),
            ('background', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('one', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['chargen.dChar_class'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('six', self.gf('django.db.models.fields.IntegerField')(default=8)),
        ...
        db.send_create_signal('chargen', ['personalities'])
    ...
    models = {
        ...
        'chargen.dbonds': {
            ...
            'five': ('django.db.models.fields.CharField', [], {'max_length': '600'}),
            'four': ('django.db.models.fields.CharField', [], {'max_length': '600'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'one': ('django.db.models.fields.CharField', [], {'max_length': '600'}),
            'six': ('django.db.models.fields.CharField', [], {'max_length': '600'}),
            'three': ('django.db.models.fields.CharField', [], {'max_length': '600'}),
            'two': ('django.db.models.fields.CharField', [], {'max_length': '600'})
        },
        'chargen.dchar_class': {
        ...
        'chargen.dpersonalities': {
            ...
            'background': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'eight': ('django.db.models.fields.CharField', [], {'max_length': '600'}),
            'five': ('django.db.models.fields.CharField', [], {'max_length': '600'}),
            'four': ('django.db.models.fields.CharField', [], {'max_length': '600'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'one': ('django.db.models.fields.CharField', [], {'max_length': '600'}),
            'seven': ('django.db.models.fields.CharField', [], {'max_length': '600'}),
            'six': ('django.db.models.fields.CharField', [], {'max_length': '600'}),
            'three': ('django.db.models.fields.CharField', [], {'max_length': '600'}),
            'two': ('django.db.models.fields.CharField', [], {'max_length': '600'})
        },
