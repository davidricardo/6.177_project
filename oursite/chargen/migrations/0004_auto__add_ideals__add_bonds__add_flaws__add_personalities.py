...
class Migration(SchemaMigration):
    ...
    models = {
        'chargen.bonds': {
            ...
            'five': ('django.db.models.fields.IntegerField', [], {'default': '8'}),
            'four': ('django.db.models.fields.IntegerField', [], {'default': '8'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'one': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['chargen.dChar_class']"}),
            'six': ('django.db.models.fields.IntegerField', [], {'default': '8'}),
            'three': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['chargen.dRace']"}),
            'two': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['chargen.dsubclass']"})
        },
        'chargen.darmors': {
        ...
        'chargen.personalities': {
            'Meta': {'object_name': 'personalities'},
            'background': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'eight': ('django.db.models.fields.IntegerField', [], {'default': '8'}),
            'five': ('django.db.models.fields.IntegerField', [], {'default': '8'}),
            'four': ('django.db.models.fields.IntegerField', [], {'default': '8'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'one': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['chargen.dChar_class']"}),
            'seven': ('django.db.models.fields.IntegerField', [], {'default': '8'}),
            'six': ('django.db.models.fields.IntegerField', [], {'default': '8'}),
            'three': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['chargen.dRace']"}),
            'two': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['chargen.dsubclass']"})
        },
